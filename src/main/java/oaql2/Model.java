...
public class Model {
	...
	/** Flag for String data type in OAQL2 */
	public static final char STR_TYPE = 1;

	/** Flag for Number data type in OAQL2 */
	public static final char NUM_TYPE = 2;

	/** Flag for Boolean data type in OAQL2 */
	public static final char BOOL_TYPE = 4;

	/** Flag for array in OAQL2 */
	public static final char ARRAY_TYPE = 8;

	/** Flag for Any data type in OAQL2 */
	public static final char ANY_TYPE = (char)(STR_TYPE | NUM_TYPE | BOOL_TYPE);
	
	/** Number of unwind stages to be added to pipeline for each table */
	public int unwindsNum;

	/** List of all locations of each table inside a metadata object */
	public ArrayList<String> paths;

	/** List of all locations of each table inside a metadata object, in a format that can be added directly to the MongoDB pipeline */
	public Object pathsForConcat;

	/** List of each table's children tables in a format to be added directly to the MongoDB pipeline */
	...
	/**
	 * Calculates info for each table and stores it for easy access in the future
	 * 
	 * @param tableName the table for which to calculate the info
	 * 
	 */
	 ...
	 * 
	 * @param table the array name to find all of its locations
	 * @param propNum used to avoid infinite recursion in case of cyclic paths, pass 0 when calling the method
	 * @return a list of all locations of the array
	 *
	 */
