...
/**
 * Parser that creates the metadata object from an OpenAPI description and inserts it into the database
 */
public class DescriptionParser{

	/** Helper object to hold the OpenAPI description while it is parsed */
	 ...
	 * 
	 * @param mongoUrl the URL of the MongoDB service
	 ...
	 * 
	 * @param dest the object that the field(s) will be copied into
	 * @param src the object to copy the field(s) from
	 * @param key the names of one or more fields to copy
	 * 
	 */
	...
	/**
	 * Copies one field from src to dest under the destKey if it exists in src
	 * 
	 * @param dest the object that the field will be copied into
	 * @param destKey the name of the new field in dest
	 * @param src the object to copy the field from
	 * @param srcKey the name of the field to be copied
	 * 
	 */
	 ...
	 * 
	 * @param desc a string with the OpenAPI description to be parsed
	 ...
	 * 
	 * @param tags a JSON array from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param reqs a JSON array from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 */
	...
	/**
	 * Returns the object pointed to by a string reference
	 * 
	 * @param path the reference path
	 * @return the JSON object that is referenced
	 * 
	 */
	 ...
	 * 
	 * @param obj an OpenAPI Reference object
	 ...
	 * 
	 * @param headers a JSON object from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param links a JSON object from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param responses a JSON object from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param example a value of a single example from the OpenAPI description
	 * @param examples a JSON object with multiple examples from the OpenAPI description
	 * @return a JSON array to be added to the metadata object with all examples from the arguments
	 * 
	 */
	 ...
	 * 
	 * @param schema a JSON object from the OpenAPI description describing a schema, property or item
	 * @param encoding an Encoding object if existing, otherwise null
	 * @param name the name of the Property if parsing a property, otherwise null
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param dest the object to copy the fields into
	 * @param source the object to copy the fields from
	 * 
	 */
	...
	/**
	 * Checks if arr contains obj with .equals method
	 * 
	 * @param arr the array that may contain obj
	 * @param obj the object that may be contained in arr
	 * @return true if .equals method returns true for at least one element inside arr and false otherwise
	 * 
	 */
	...
	/**
	 * Creates a copy of resultArray for each value in newproperty and
	 * appends that value to each object in the corresponding copy of
	 * resultArray in an array named key, then merges all arrays and 
	 * returns the result
	 * 
	 * @param resultArray the resultArray
	 * @param newproperty an array with the new values
	 * @param key the name of the new array
	 * @return the result of the described merge
	 * 
	 */
	...
	/**
	 * Creates a copy of resultArray for each object in newarr and
	 * copies all key-value pairs from that object to each object 
	 * in the corresponding copy 
	 * 
	 * @param resultArray the resultArray
	 * @param newarr an array with the new objects
	 * 
	 */
	 ...
	 * 
	 * @param param a JSON object from the OpenAPI description
	 * @return a JSON object to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param callbacks a JSON object from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param webhooks a JSON object from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param path the path of the endpoint described in the OpenAPI description or null when parsing webhooks
	 * @param pathitem a JSON object from the OpenAPI description about the endpoint
	 * @param baseSecurity a JSON object from the OpenAPI description about security rules of all endpoints (null if no such object exists)
	 * @param baseServers a JSON object from the OpenAPI description about the servers of the web service (null if no such object exists)
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param paths a JSON object from the OpenAPI description
	 * @param baseSecurity a JSON object from the OpenAPI description about general security rules (null if no such object exists)
	 * @param baseServers a JSON object from the OpenAPI description about the servers of the web service (null if no such object exists)
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param content a JSON object from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param serv a JSON array from the OpenAPI description
	 * @return a JSON array to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param server a JSON object from the OpenAPI description
	 * @return a JSON object to be added to the metadata object
	 * 
	 */
	 ...
	 * 
	 * @param newobj the object from the OpenAPI description
	 * @param extdocsobj the object that will be added in the metadata object
	 * 
	 */
